...
<footer class="kv-footer">
  ...
  <div class="container">
    ...
    <div class="kv-newsletter">
      ...
      <small>En vous inscrivant, vous acceptez notre <a href="">Politique de confidentialité</a>.</small>
    </div>
    ...
    <div class="footer-container">
      <div class="footer-col">
        ...
        <p>Votre boutique en ligne pour meubles, déco et bricolage. Sélection soignée, prix justes, service aux petits soins.</p>
...
.kv-usp .usp{
  ...
  background:#1f4e5f; border:1px solid #1f4e5f;
  padding:10px 12px; border-radius:20px;


}
.kv-usp .usp i{ font-size:18px; }

/* ===== Footer Keluvato avec bulles 3D ===== */
.kv-footer{
  position:relative; overflow:hidden; color:#eef6f9;
  padding:50px 0 20px;
  background: radial-gradient(1200px 600px at 100% 120%, #1f4e5f 0%, #1f4e5f 45%, #1f4e5f 80%, #1f4e5f 100%);
  isolation:isolate;
}
.kv-footer .container{ max-width:1200px; margin:0 auto; padding:0 16px; }

/* Bulles décoratives */
.kv-footer .kv-orbs{ position:absolute; inset:-10% -10% -10% -10%; z-index:-1; }
.kv-footer .kv-orbs .orb{
  position:absolute; width:clamp(18px,2.2vw,28px); height:clamp(18px,2.2vw,28px);
  border-radius:50%;
  background:
  ...
  opacity:.85; animation: kv-float var(--dur,18s) ease-in-out infinite;
}
.kv-footer .kv-orbs .orb:nth-child(1){ top:10%; left:6%;  --dur:22s; animation-delay:-3s;  scale:1.1;}
.kv-footer .kv-orbs .orb:nth-child(2){ top:25%; right:10%; --dur:17s; animation-delay:-8s;  scale:.9;}
.kv-footer .kv-orbs .orb:nth-child(3){ top:55%; left:14%; --dur:19s; animation-delay:-12s; scale:1.25;}
.kv-footer .kv-orbs .orb:nth-child(4){ top:70%; right:18%;--dur:21s; animation-delay:-5s;  scale:1.05;}
.kv-footer .kv-orbs .orb:nth-child(5){ top:40%; left:45%; --dur:24s; animation-delay:-10s; scale:.95;}
.kv-footer .kv-orbs .orb:nth-child(6){ top:12%; right:38%;--dur:16s; animation-delay:-2s;  scale:1.2;}
@keyframes kv-float{
  0%{transform:translateY(0) translateX(0) rotate(0deg)}
  25%{transform:translateY(-14px) translateX(8px) rotate(8deg)}
  50%{transform:translateY(6px) translateX(-6px) rotate(-6deg)}
  75%{transform:translateY(-10px) translateX(4px) rotate(5deg)}
  100%{transform:translateY(0) translateX(0) rotate(0deg)}
}

/* Grille colonnes */
.kv-footer .footer-container{
  display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:32px; margin-top:26px;
}
.kv-footer .footer-col h3{ font-size:1.05rem; letter-spacing:.3px; margin-bottom:12px; color:#e9fcff; }
.kv-footer .footer-col p{ color:#d3e7eb; line-height:1.7; font-size:.95rem; }
.kv-footer .footer-col ul{ list-style:none; padding:0; margin:0; }
.kv-footer .footer-col li{ margin:.45rem 0; }
.kv-footer a{ color:#cfeef3; text-decoration:none; transition:color .2s ease, transform .2s ease; }
.kv-footer a:hover{ color:#ffffff; transform:translateX(2px); }

/* Newsletter */
.kv-footer .kv-newsletter{ text-align:center; margin-bottom:10px; }
.kv-footer .kv-newsletter h3{ margin-bottom:6px; }
.kv-footer .kv-newsletter p{ color:#d3e7eb; margin-bottom:14px; }
.kv-footer .kv-news-form{ display:flex; justify-content:center; gap:8px; flex-wrap:wrap; }
.kv-footer .kv-news-form input{
  min-width:260px; padding:12px 14px; border-radius:10px; border:1px solid rgba(255,255,255,.18); background:rgba(255,255,255,.06);
  color:#fff; outline:none;
}
.kv-footer .kv-news-form input::placeholder{ color:#cfeef3; opacity:.8; }
.kv-footer .kv-news-form .btn-news{
  padding:12px 16px; border-radius:10px; border:1px solid rgba(255,255,255,.25);
  background:#1f4e5f; color:#fff; cursor:pointer; transition:transform .2s ease, background .2s ease;
}
.kv-footer .kv-news-form .btn-news:hover{ transform:translateY(-2px); background:#143743; }
.kv-footer small a{ text-decoration:underline; }

/* Confiance & paiements */
.kv-footer .kv-trust{ margin-top:16px; }
.kv-footer .kv-trust .badges{ display:flex; flex-wrap:wrap; gap:8px; margin-bottom:10px; }
.kv-footer .kv-trust .badge{
  font-size:.82rem; padding:6px 10px; border-radius:999px;
  background:rgba(255,255,255,.08); border:1px solid rgba(255,255,255,.14);
}
.kv-footer .kv-trust .payments{ display:flex; gap:12px; font-size:26px; opacity:.95; }

/* Apps & préférences */
.kv-footer .kv-apps{ display:flex; gap:10px; margin-top:10px; }
.kv-footer .kv-apps .store{
  padding:8px 12px; border-radius:10px; background:rgba(255,255,255,.08);
  border:1px solid rgba(255,255,255,.14); font-size:.9rem;
}
.kv-footer .kv-prefs{ display:flex; gap:8px; margin-top:10px; }
.kv-footer .kv-prefs select{
  background:rgba(255,255,255,.08); border:1px solid rgba(255,255,255,.14); color:#e9fcff;
  padding:8px 10px; border-radius:10px;
}

/* Bas de page */
.kv-footer .copyright{
  border-top:1px solid rgba(255,255,255,0.08); margin-top:26px; padding-top:16px;
  text-align:center; color:#b7d7dd; font-size:.9rem;
}

/* Responsive */
@media (max-width: 992px){
  .kv-usp .kv-usp-wrap{ grid-template-columns:repeat(2,minmax(0,1fr)); }
  .kv-footer .footer-container{ grid-template-columns:repeat(2,minmax(0,1fr)); }
}
@media (max-width: 560px){
  .kv-usp .kv-usp-wrap{ grid-template-columns:1fr; }
  .kv-footer{ padding-top:40px; }
  .kv-footer .footer-container{ grid-template-columns:1fr; }
}
